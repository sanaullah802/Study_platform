...
const Aptitude = () => {
    ...
    const { currentUser } = useContext(AuthContext);
        ...
        useEffect(() => {
            // Query messages for aptitude room
    ...
    return (
        <div className='flex flex-col h-screen bg-gray-100'>
            <div className="bg-white shadow-sm">
                <h1 className='text-2xl font-bold p-4 text-center'>Aptitude Study Group</h1>
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto p-6">
                    <MaterialsList groupId="aptitude" groupName="Aptitude" />
                </div>
            )}
        </div>
    );
