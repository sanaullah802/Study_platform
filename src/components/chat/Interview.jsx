...
const Interview = () => {
    ...
    const [activeTab, setActiveTab] = useState('chat'); // 'chat' or 'materials'
    ...
    const { currentUser } = useContext(AuthContext);
        ...
        useEffect(() => {
            // Query messages for interview room
            const queryMessages = query(
                messageRef,
                where("room", "==", "interview"),
    ...
    return (
        <div className='flex flex-col h-screen bg-gray-100'>
            ...
            <div className="bg-white shadow-sm">
                <h1 className='text-2xl font-bold p-4 text-center'>Interview Preparation Group</h1>
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto p-6">
                    <MaterialsList groupId="interview" groupName="Interview Preparation" />
                </div>
            )}
        </div>
    );
